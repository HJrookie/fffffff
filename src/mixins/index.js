export default {
  ...
  activated() {
    ...
    // if (this.mixinOptions.activatedIsNeed) {
    // this.query();
    // }
  },
  created() {
  ...
  methods: {
    ...
    resetHandle(refName = "form") {
      ...
      // if (this.mixinOptions.clearSelection) {
      //   this.$refs.table.clearSelection();
      // }
      // if (this.mixinOptions.clearSort) {
    ...
    deleteHandle(id) {
      ...
      l("isOnly", isOnly, Boolean(this.mixinOptions.deleteAjax), id);
