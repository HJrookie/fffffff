...
import { getAllCoachApplys, getAllunitAppls, getUsers } from "@/api/userManage";
export default {
  name: "ChangeCoachToReferee", // 这个页面是 参赛单位发起申请, 将教练变成裁判的页面
  components: {
    // AddOrUpdate,
    ApplyDetailInfo,
    NewApply,
  ...
  data() {
    ...
    return {
      ...
      tableData: [],
      mixinOptions: {
        getDataListAjax: getAllCoachApplys,
