...
<script>
import { getFileInfoById, getPersonContestApplyInfoById, rejectOrganizerApprove, changeCBApproveStatus } from "@/api/contestManage";
      ...
      this.$refs.form.validate((valid) => {
        if (valid) {
          const data = {
            ...
            id: this.info.id,
            applyPersonalId: this.info.applyPersonalId,
            isPartTime: this.info.isPartTime,
            status: 1, // 代表通过
            applyIdentity: this.info.applyIdentity,
          };
          changeCBApproveStatus(data)
            .then((res) => {
